...
def train_engine(__C, dataset, dataset_eval=None):
    ...
    is_fusion = (vis_feat in ('fusion', 'radarxf_fusion', 'trimodal_fusion'))
    label_smoothing = getattr(__C, 'LABEL_SMOOTHING', 0.0) if vis_feat in ('fusion', 'radarxf_fusion', 'trimodal_fusion', 'annot', 'detected', 'radarxf') else 0.0
